...
| 镜像规格                            | 特性说明                                           | 备注 |
|---------------------------------|------------------------------------------------| --- |
| [Cassandra-4.1.3-kunpeng-HCE](https://github.com/HuaweiCloudDeveloper/cassandra-image/tree/Cassandra-4.1.3-kunpeng-HCE) | 基于 鲲鹏服务器 + Huawei Cloud EulerOS 2.0 64bit 安装部署 |  |
